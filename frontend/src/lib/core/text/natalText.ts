...
export const LAGNA_TRAITS: Record<number, Bi> = {
  ...
  3: { en: 'With Cancer (Karka) rising you are sensitive, nurturing, and intuitive — deeply tied to home, family, and emotional security. Ruled by the Moon, your moods colour your whole outlook.', si: 'කර්ක ලග්නයෙන් උපන් ඔබ සංවේදී, පෝෂණය කරන හා ඉවෙන් දැනගන්නා — නිවස, පවුල හා හැඟීම්බර සුරක්ෂිතභාවය සමඟ ගැඹුරින් බැඳුණු. චන්ද්‍රයාගෙන් පාලනය වන ඔබේ මනෝභාවයන් ඔබේ මුළු දෘෂ්ටියම වර්ණවත් කරයි.' },
