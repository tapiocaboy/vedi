...
export const NakshatraInfo: React.FC<Props> = ({ nakshatra, title = "Moon Nakshatra" }) => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          ...
          <div className="text-xs text-white/30 font-mono mt-0.5">
            #{nakshatra.index + 1} &middot; Pada {nakshatra.pada}
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2 text-sm">
        <div className="bg-white/3 rounded-lg p-3 border border-white/6">
          <div className="text-[10px] text-white/30 mb-1 uppercase tracking-wider">Ruling Planet</div>
        ...
        {nakshatra.symbol && (
          <div className="bg-white/3 rounded-lg p-3 border border-white/6 col-span-2">
            <div className="text-[10px] text-white/30 mb-1 uppercase tracking-wider">Symbol</div>
