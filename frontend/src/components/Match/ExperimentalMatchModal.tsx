            ...
            <div className="px-7 py-5 space-y-4">
              <div className="disclaimer-hero rounded-xl px-5 py-4">
                <p className="text-sm font-semibold disclaimer-text-primary leading-snug">
                  Horoscope Matching is still in development.
                </p>
                <p className="text-sm disclaimer-text-secondary mt-1.5 leading-relaxed">
                  This feature is experimental — compatibility scores and dosha checks may be incomplete or inaccurate.
                  Use it for exploration only, not for real relationship decisions.
                </p>
              </div>
            </div>
